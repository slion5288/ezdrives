...
export async function register(body: { role?: 'student' | 'instructor'; name: string; email?: string; phone: string; password: string; address?: string; code?: string }): Promise<LoginResult> {
