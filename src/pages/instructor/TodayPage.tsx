...
import { dateKey, formatDateZh, formatHM, fromLocalISO } from '../../data/timeEngine'
            ...
            <div className="ins-today__card">
              <div className="ins-today__when">
                <span className="ins-today__date tabular-nums">
                  {locale === 'zh' ? formatDateZh(fromLocalISO(next.start)) : formatDateZh(fromLocalISO(next.start))}
                </span>
              ...
              <div className="ins-today__side">
                ...
                <span className="ins-today__price tabular-nums">{formatMoney(next.price ?? courseById(state, next.courseId)?.price ?? 0)}</span>
              </div>
            </div>
          </>
        )}
