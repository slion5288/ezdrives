...
('tpl_welcome', 'STUDENT_REGISTERED', 'Student Welcome', 'Welcome to EZDRIVES, {{student_name}}! / 欢迎加入 EZDRIVES，{{student_name}}！',
...
('tpl_phone_verified', 'PHONE_VERIFIED', 'Phone Verified', 'Your phone number has been verified / 手机号已验证',
...
('tpl_booking_confirmed', 'BOOKING_CONFIRMED', 'Booking Confirmed', 'Your {{course_name}} lesson is confirmed / {{course_name}} 预约已确认',
...
('tpl_booking_cancelled', 'BOOKING_CANCELLED', 'Booking Cancelled', 'Your {{course_name}} lesson was cancelled / {{course_name}} 预约已取消',
...
('tpl_booking_rescheduled', 'BOOKING_RESCHEDULED', 'Booking Rescheduled', 'Your {{course_name}} lesson was rescheduled / {{course_name}} 预约已改期',
...
('tpl_booking_reminder', 'BOOKING_REMINDER', 'Booking Reminder', 'Reminder: {{course_name}} lesson / 上课提醒：{{course_name}}',
...
('tpl_account_update', 'ACCOUNT_UPDATED', 'Account Update', 'Your EZDRIVES account was updated / 您的 EZDRIVES 账号已更新',
...
('tpl_password_reset', 'PASSWORD_RESET', 'Password Reset', 'Reset your EZDRIVES password / 重置您的 EZDRIVES 密码',
...
('tpl_instructor_new_booking', 'NEW_BOOKING', 'Instructor: New Booking', 'New booking: {{course_name}} / 新预约：{{course_name}}',
...
('tpl_instructor_booking_cancelled', 'INSTRUCTOR_BOOKING_CANCELLED', 'Instructor: Booking Cancelled', 'Booking cancelled: {{course_name}} / 预约已取消：{{course_name}}',
...
('tpl_instructor_booking_rescheduled', 'INSTRUCTOR_BOOKING_RESCHEDULED', 'Instructor: Booking Rescheduled', 'Booking rescheduled: {{course_name}} / 预约已改期：{{course_name}}',
...
('tpl_instructor_schedule_update', 'SCHEDULE_UPDATE', 'Instructor: Schedule Update', 'Your schedule has been updated / 您的日程已更新',
...
('tpl_system', 'SYSTEM_NOTIFICATION', 'System Notification', 'EZDRIVES system notice / EZDRIVES 系统通知',
...
('tpl_important_account', 'IMPORTANT_ACCOUNT', 'Important Account Notice', 'Important: action needed on your EZDRIVES account / 重要：您的 EZDRIVES 账号需要处理',
...
('tpl_new_purchase', 'NEW_PURCHASE', 'New Course Purchase', 'New Course Purchase — {{student_name}} / 新课程购买——{{student_name}}',
...
('tpl_purchase_confirmed', 'PURCHASE_CONFIRMED', 'Purchase Confirmed', 'Your purchase is confirmed — {{course_name}} / 购买已确认——{{course_name}}',
...
('tpl_payment_rejected', 'PAYMENT_REJECTED', 'Payment Rejected', 'Payment update — {{course_name}} / 支付通知——{{course_name}}',
...
('tpl_lesson_completed', 'LESSON_COMPLETED', 'Lesson Completed', 'Lesson {{lesson_number}} completed — {{course_name}} / 第 {{lesson_number}} 课已完成——{{course_name}}',
...
('tpl_doc_uploaded', 'DOCUMENT_UPLOADED', 'Certificate Documents Uploaded', 'Certificate documents uploaded — {{student_name}} / 证书证件已上传——{{student_name}}',
...
('tpl_cash_request', 'CASH_REQUEST', 'Cash Payment Request', 'Cash payment request — {{student_name}} / 现金支付申请——{{student_name}}',
...
('tpl_cash_approved', 'CASH_APPROVED', 'Cash Payment Approved', 'Cash payment approved — book your first lesson / 现金支付已批准——可预约第一节课',
...
('tpl_cash_received', 'CASH_RECEIVED', 'Cash Payment Received', 'Payment received — all lessons unlocked / 已收到现金——全部课程已解锁',
...
('tpl_cash_reminder', 'CASH_REMINDER', 'Cash Payment Reminder', 'Reminder: cash payment for {{course_name}} / 现金支付提醒：{{course_name}}',
