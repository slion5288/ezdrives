...
('tpl_doc_uploaded', 'DOCUMENT_UPLOADED', 'Certificate Documents Uploaded',
 'Certificate documents uploaded — {{student_name}}',
 '<div style="font-family:Arial,sans-serif;max-width:600px;margin:auto"><h2 style="color:#A21CAF">Certificate Documents Uploaded</h2><p>A student uploaded their driver licence documents for the Full Course Certificate service.</p><table style="width:100%;border-collapse:collapse;font-size:14px"><tr><td style="padding:6px 0;color:#667085"><b>Student</b></td><td style="padding:6px 0">{{student_name}}</td></tr><tr><td style="padding:6px 0;color:#667085"><b>Phone</b></td><td style="padding:6px 0">{{student_phone}}</td></tr><tr><td style="padding:6px 0;color:#667085"><b>Email</b></td><td style="padding:6px 0">{{student_email}}</td></tr><tr><td style="padding:6px 0;color:#667085"><b>Service</b></td><td style="padding:6px 0">{{course_name}}</td></tr><tr><td style="padding:6px 0;color:#667085"><b>Documents</b></td><td style="padding:6px 0">Front ✓ · Back ✓</td></tr></table><p style="color:#667085;font-size:13px">Sign in to review the documents securely.</p><p style="color:#667085;font-size:13px">— EZDRIVES</p></div>',
 'Certificate Documents Uploaded\n\nStudent: {{student_name}}\nPhone: {{student_phone}}\nEmail: {{student_email}}\nService: {{course_name}}\nDocuments: Front ✓ · Back ✓\n\nSign in to review the documents securely.',
 1, 1, '');
