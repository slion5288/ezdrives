...
('tpl_wechat_request', 'WECHAT_REQUEST', 'WeChat Payment Pending', 'New WeChat payment pending — {{student_name}} / 新的微信支付待确认——{{student_name}}',
...
('tpl_wechat_confirmed', 'WECHAT_CONFIRMED', 'WeChat Payment Confirmation', 'Payment Confirmation / 付款确认 — {{course_name}}',
...
('tpl_emt_request', 'EMT_REQUEST', 'EMT Payment Pending', 'New EMT payment pending — {{student_name}} / 新的 EMT 转账待确认——{{student_name}}',
...
('tpl_emt_confirmed', 'EMT_CONFIRMED', 'EMT Payment Confirmation', 'Payment Confirmation / 付款确认 — {{course_name}}',
